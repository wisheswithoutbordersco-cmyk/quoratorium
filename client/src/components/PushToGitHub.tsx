      ...
      <div className="space-y-3">
        <div>
          ...
          <select
            ...
            className="w-full px-3 py-2 rounded-lg bg-white/5 border border-white/10 text-sm text-white/80 outline-none focus:border-orange-500/30 transition-colors"
          >
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="flex-1 px-3 py-2 rounded-lg bg-white/5 border border-white/10 text-sm text-white/80 outline-none focus:border-orange-500/30 transition-colors"
            >
              {branches?.map((b: any) => (
        ...
        <div>
          ...
          <textarea
            ...
            rows={2}
            className="w-full px-3 py-2 rounded-lg bg-white/5 border border-white/10 text-sm text-white/80 outline-none focus:border-orange-500/30 resize-none transition-colors"
        ...
        <div className="flex gap-2 pt-1">
          ...
          <button
            ...
            className="flex-1 px-3 py-2 rounded-lg bg-orange-500/20 hover:bg-orange-500/30 border border-orange-500/30 text-xs text-orange-300 hover:text-purple-200 transition-all disabled:opacity-40 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {isPushing ? (
              <>
