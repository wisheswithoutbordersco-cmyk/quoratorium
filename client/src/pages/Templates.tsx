...
const TEMPLATES: Template[] = [
  {
    ...
    name: "Contractor CRM",
    description:
      "Client management, job scheduling, invoicing, and crew coordination for contractors",
    icon: Users,
    color: "#3B82F6",
  ...
  },
  {
    ...
    description:
      "Analytics dashboard for AI/ML products with usage metrics, model performance, and billing",
    icon: BarChart3,
    color: "#f59a44",
  ...
  },
  {
    ...
    description:
      "Member directory, event scheduling, donations tracking, and volunteer coordination",
    icon: Church,
    color: "#F59E0B",
  ...
  },
  {
    ...
    description:
      "Online menu, ordering system, table reservations, and kitchen display",
  ...
  },
  {
    ...
    description:
      "Job estimation, crew scheduling, material ordering, and weather-aware planning",
    icon: HomeIcon,
    color: "#10B981",
  ...
  },
  {
    ...
    description:
      "Landing pages, form builders, lead scoring, email sequences, and conversion tracking",
    icon: Target,
    color: "#EC4899",
  ...
  },
  {
    ...
    description:
      "Creative portfolio with project showcase, about section, blog, and contact form",
    icon: Briefcase,
    color: "#6366F1",
  ...
  },
  {
    ...
    description:
      "Product catalog, shopping cart, checkout flow, order management, and inventory",
    icon: ShoppingCart,
    color: "#F97316",
  ...
  },
  {
    ...
    name: "Landing Page",
    description:
      "High-converting landing page with hero, features, testimonials, pricing, and CTA",
    icon: Rocket,
    color: "#14B8A6",
  ...
  },
  {
    ...
    description:
      "Content management with articles, categories, author profiles, and SEO optimization",
    icon: FileText,
    color: "#64748B",
...
export default function Templates() {
  ...
  const handleUseTemplate = async (template: Template) => {
    setTemplateBuild({ id: template.id, status: "Creating project…" });
    ...
    try {
      ...
      setTemplateBuild({
        id: template.id,
        status: "Starting the build pipeline…",
      });

      // This invokes the same Captain → Builder → Validator pipeline used by
      // the Projects page. Do not present a generated-code success until the
      // mutation returns successfully.
      const build = await buildProject.mutateAsync({
      ...
      await utils.projects.list.invalidate();
      toast.success(
        `Build complete — ${build.filesGenerated} ${build.filesGenerated === 1 ? "file" : "files"} generated`
      );
      setLocation("/projects");
    } catch (error) {
      const message = error instanceof Error ? error.message : "Unknown error";
      toast.error(`Template project was not fully built: ${message}`);
    } finally {
        ...
        <div className="max-w-6xl mx-auto px-6 py-8">
          ...
          >
            ...
            <p className="text-sm text-muted-foreground">
              Start with a pre-configured template. This creates a project and
              starts its AI build pipeline.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {filtered.map((template, i) => {
              ...
              const isLoading = templateBuild?.id === template.id;
              const isAnotherTemplateBuilding =
                templateBuild !== null && !isLoading;
              return (
                <motion.div
                  key={template.id}
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    {/* Content */}
                    <h3 className="text-sm font-display text-foreground mb-1">
                      {template.name}
                    </h3>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <motion.button
                        ...
                        disabled={isLoading || isAnotherTemplateBuilding}
