...
registerTool({
  name: "create_file",
  description: "Create or update a project file only when the user explicitly asks Toríu to build an application, produce code files, or save content as a file. Do not use for ordinary explanations, brainstorming, prompt writing, image concepts, or conversational advice. For an explicit web project, index.html may be used as the entry point.",
  parameters: {
    type: "object",
    properties: {
      filename: {
